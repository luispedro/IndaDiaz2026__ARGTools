...
Original information from GMGC after filtering for those unigenes identified as ARGs found in file `args_abundances.tsv.gz`. The file has the same structure as GMGC. Note that the abundance here is scaled to 10 million per metagenome. 
